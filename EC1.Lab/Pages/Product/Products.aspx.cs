...
using GalaxyShoes.Pages.Product.Events;
using GalaxyShoes.Pages.Product.Sub_Pages;
using GalaxyShoes.Services;
...
using static GalaxyShoes.Pages.Product.Sub_Pages.GridViewControl;

namespace GalaxyShoes
{
