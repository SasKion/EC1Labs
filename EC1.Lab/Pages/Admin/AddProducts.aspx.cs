...
namespace GalaxyShoes.Project.Pages.AdminStuff
{
    public partial class AddProducts : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string shoesExtention = String.Concat("/Images/", file);
                var shoesdescription = Request.Form["txtdescription"];
                using (var context = new ApplicationDbContext())
                {
                    context.Products.Add(new Product
                    {
                        ...
                        ShortDescription = shoesdescription,
                        ImageFile = shoesExtention,
                    });
                    context.SaveChanges();
                };
            }
