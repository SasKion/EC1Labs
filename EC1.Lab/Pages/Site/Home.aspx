<%@ Page Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="GalaxyShoes.Home" %>
...
<asp:Content ID="ContentHome" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="home">
        <h1 class="" style="padding: 10px">Welcome
            ...
            to
            <br />
            <span class="">Galaxy Shoes </span>
        </h1>
        <div style="padding-bottom:100px;">
            <h2 class="slogan" style="font-style: italic">Galaxy the shoes people
            </h2>
        </div>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" style="width:1280px; margin:auto; transition: .6s ease-in-out">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Collect all the best shoes</h5>
                        <p>...</p>
                    </div>
                </div>
                <div class="carousel-item">
        ...
        <p style="text-align: center">
            Here we provide a variety of different products 
            <br />
