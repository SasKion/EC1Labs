<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="AddProducts.aspx.cs" Inherits="GalaxyShoes.Project.Pages.AdminStuff.AddProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="container-fluid" style="height: auto; text-align: left">
        <div class="topic">
            <h1 style="color: black;">Add a Shoes</h1>
        </div>
        ...
        <div class="pt-5">
         ...
         <%--   <div class="alert alert-success" role="alert">
                ...
                <strong>Success!</strong> shoes Added successfully!
            </div>--%>
            <br />
            shoes name:<br>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server"
                ErrorMessage="Enter the name of the shoes" ControlToValidate="txtname"
