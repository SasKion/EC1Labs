<%@ Page Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="GalaxyShoes.Register" %   >
...
<asp:Content ID="ContentRegister" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="regContainer container-fluid" style="height:auto">
        ...
        <div class="container" style="padding-top:30px">
            ...
            <div class="form-group row">
                <asp:Label ID="lbldob" runat="server" class="col-md-4 col-form-label no-wrap" Text="Date Of Birth"></asp:Label>
                ...
                <div class="col-md-1">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Enter Day" ControlToValidate="txtday" ForeColor="Red">*</asp:RequiredFieldValidator>
                </div>
                <div class="col-md-1">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="Enter Month" ControlToValidate="txtmonth" ForeColor="Red">*</asp:RequiredFieldValidator>
                </div>
                <div class="col-md-1">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" ErrorMessage="Enter Year" ControlToValidate="txtyear" ForeColor="Red">*</asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="form-group row">
