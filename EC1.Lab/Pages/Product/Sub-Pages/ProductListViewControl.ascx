<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductListViewControl.ascx.cs" Inherits="GalaxyShoes.Pages.Product.Sub_Pages.ProductListViewControl" %>
...
<div class="row align-content-center">
    ...
    <asp:SqlDataSource ID="ProductListSource" runat="server" ConnectionString="<%$ ConnectionStrings:GalaxyShoes %>"
