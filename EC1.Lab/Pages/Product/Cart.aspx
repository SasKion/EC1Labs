<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Main.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="GalaxyShoes.Items" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContentPlaceHolder" runat="server">
    <div class="align-items-center container-fluid" style="min-height: 100%">
        ...
        <div class="card text-white bg-info mb-3" style="margin: auto">
            ...
            <div class="card-header">Item(s)</div>
            <div class="card-body">
